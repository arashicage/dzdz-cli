...
LOAD DATA
INFILE '01_01_10000000_1.txt' "STR X'0a'" 
INFILE '01_01_10000000_2.txt' "STR X'0a'" 
INFILE '01_01_10000000_3.txt' "STR X'0a'" 
INFILE '01_01_10000000_4.txt' "STR X'0a'" 
INFILE '01_01_10000000_5.txt' "STR X'0a'" 
INFILE '01_01_10000000_6.txt' "STR X'0a'" 
INFILE '01_01_10000000_7.txt' "STR X'0a'" 
INFILE '01_01_10000000_8.txt' "STR X'0a'" 
INFILE '01_01_10000000_9.txt' "STR X'0a'" 
INFILE '01_01_10000000_10.txt' "STR X'0a'"
INFILE '01_01_10000000_11.txt' "STR X'0a'"
INFILE '01_01_10000000_12.txt' "STR X'0a'"
APPEND INTO TABLE dzdz_fpxx_zzsfp
